...
<html lang="es">
<?php
if(!isset($_SESSION["auth"]) || $_SESSION["auth"]["usuario"]=="admin"){   
...
.list-group-item {
  ...
  background-color: #FFFFFF !important;
    ...
    ul,li{font-family: 'Roboto', sans-serif; }
        ...
        body{background-color:#ededed !important;font-size:16px  !important;}
    </style>
...
<section id="piePagina" style="background-color:#0059b0;padding-top:20px;">
  <div class="container">
      <div class="row">
          <div class="col-md-4">
            <div><img src="logoClick.png" style="width:60%;max-width:100%;"/></div>
...
// Aquí puedes realizar la lógica adicional o enviar el formulario mediante AJAX
