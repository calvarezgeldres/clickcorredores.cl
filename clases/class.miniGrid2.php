            ...
            while($row=$this->paginator->devolverResultados()){
                    ...
                    echo "</td>";
                      ...
                      if($row["precioUf"]==1){
                          ...
                          if(preg_match("/\./i",$row["precio"])){
                              ...
                              echo $this->formatoNumerico($row["precio"])." U.F";
                          }          
                      }
                  echo '</span> &nbsp;&nbsp; | &nbsp;&nbsp;<i class="fas fa-images"></i><span style="font-size:12px;"> '.$this->numFotos($row["idProp"])."</span>";
                      echo "</span>";
                      echo "</div>";
                       
                      echo "<div  style='padding-bottom:5px;padding-top:5px;'>";
                      echo '<span class="badge bg-success" style="color:white !important;font-size:12px;">';
                ...
                echo '<td>                    
                        <div class="input-group input-group-sm" style="padding-top:2px;">
                            ...
                            <input type="text" class="form-control form-control-sm" value="https://clickcorredores.cl/index.php?mod=det&idProp='.$row["idProp"].'" id="input-enlace-'.$row["idProp"].'" >
                            <button class="btn btn-outline-secondary btn-sm" type="button" onclick="copiarEnlace(\'input-enlace-'.$row["idProp"].'\')">
