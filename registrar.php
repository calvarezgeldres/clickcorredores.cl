...
<div class="btn-whatsapp" align="left">
   ...
   <script> 
            function planZ(m){
      	if(m!=0){
      		alert("Para publicar y comprar un plan debes registrarte");
      ...
      $("#contactarAgente").click(function(){
      	...
      	$("#boton2").click(function(){
      	 ...
      	 return(false);
      		...
      		$("#region11").change(function(){
      	 
      	 var region=$("#region11").val();
      		 $("#comuna11").empty();
      	  $.ajax({
      			 type: "POST",
      			 url: "./include/proceso3.php",
      			 ...
      			 success: function(datos){	
      				 ...
      				 $('#comuna11').prop('disabled', false);				
      				  $('#comuna11').empty();
      				  var res=datos;
      				  for(k in res){
      					 for (i in res[k]){
      						 $("#comuna11").append("<option value="+i+">"+res[k][i]+"</option>");                    
      					 }
      				 }
      			 }
      	 });
