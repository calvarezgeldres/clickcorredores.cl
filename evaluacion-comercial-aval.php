...
.list-group-item {
  ...
  background-color: #FFFFFF !important;
    ...
    <title>Formulario de evaluación comercial Aval</title>
      ...
      <div class="container">
        <div class="row">
            <div class="col-md-9" style="padding-top:30px;">
                ...
                <?php 
                if(isset($_GET["msg"])){
                    echo '<div class="alert alert-primary" role="alert" style="margin-top:10px;font-size:16px;">
                    Formulario de evaluacion comercial de aval se ha enviado con exito, para volver a la portada haga <a href="index.php">click aqui</a>
                  </div>';
                }
                ?>
                
                <div style="margin-bottom:20px;margin-top:20px;"><h5>Formulario Aval</h5></div>
               
                <form id="form1" name="form1" action="proceso1.php" method="post" >
                <div class="mb-3">
