...
$mail->isHTML(true);
$mail->Subject = 'Formulario Aval';
$mail->Body = "
    <h2>Formulario Aval :</h2>
    <ul>
    ...
    <div style='padding-top:30px;'>Enviado desde el formulario de aval en clickcorredores.cl</div>
";

// Enviar el correo
if ($mail->send()) {
    
    header("location:evaluacion-comercial-aval.php?msg=1");
    exit;
} else {
