    ...
    $.ajax({
      ...
      success: function(datos) {  
        ...
        if (datosSin.indexOf("ok")==0) {         
          document.location="panelPropietario.php";          
        }else{
...
@media (min-width: 1200px){ 
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true"><i class="fa fa-lock"></i> &nbsp; Ingreso Propietario</button>
  </li>
...
<div class="tab-content" id="myTabContent">
  ...
  <form action="" name="form11" id="form11" method="post">
        <div class="card-body">
          <div style="margin-top:20px;"><h4>Ingreso Propietario</h4></div>
          ...
          <span class="card-title" style="color:black !important;">Ingrese su nombre de usuario y contraseña</span>
            ...
            <button class="btn btn-danger btn-mb" name="login1" id="login1" style="width:100% !important;">
