...
@media (min-width: 1200px){ 
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true"><i class="fa fa-lock"></i> &nbsp;Corredor de Propiedades</button>
  </li>
...
<div class="tab-content" id="myTabContent">
  ...
  <form action="" name="form1" id="form1" method="post">
        <div class="card-body">
          <div style="margin-top:20px;margin-bottom:20px;"><h5>Ingreso Corredor de Propiedades</h5></div>
