...
<head>
    ...
    <title>Administración de Arriendos | Inicio de Sesión</title>
  ...
  <link rel="shortcut icon" href="favicon.png"/> 
    ...
    $.ajax({
      type: "post",
      url: "./include/enterArrendatario.php",
      ...
      success: function(datos) {  
        ...
        if (datosSin.indexOf("ok")==0) {         
          document.location="panelArrendatario.php";          
        }else{
...
@media (min-width: 1200px){ 
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12" align="center" style="margin-top:60px;">
        <div align="center" style="margin-bottom:20px;"><span style="font-size:25px; color:black;"><b>Administración </b> de Arriendos</span></div>
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true"><i class="fa fa-lock"></i> &nbsp; Ingreso Arrendatario</button>
  </li>
...
<div class="tab-content" id="myTabContent">
  ...
  <form action="" name="form11" id="form11" method="post">
        <div class="card-body">
          <div style="margin-top:20px;"><h4>Ingreso Arrendatario</h4></div>
          
          <span class="card-title" style="color:black !important;">Ingrese su nombre de usuario y contraseña</span>
            <p class="card-text">
            <div class="input-group mb-3">
              <span class="input-group-text" id="basic-addon1"><i class="fas fa-user"></i></span>
              <input type="text"  name="user_name1" value="" id="user_name1" class="form-control"
               placeholder="Ingrese su correo electronico" aria-label="" aria-describedby="Usuario">
            </div>  
            
            <div class="input-group mb-3">
              <span class="input-group-text" id="basic-addon1"><i class="fas fa-lock"></i></span>
              <input type="password" value="" class="form-control" name="user_password1" id="user_password1" 
            ...
            <button class="btn btn-info btn-mb" name="login1" id="login1" style="width:100% !important;">
