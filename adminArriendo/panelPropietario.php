...
if(!isset($_SESSION["auth"]["usuario"])){  
  header("location:loginPropietario.php");
  exit;
}else{
  if($_SESSION["auth"]["tipo"]!="propi"){
    session_destroy();
    header("location:loginPropietario.php");
  exit;
  }
...
.breadcrumb .breadcrumb-item.active {
  ...
  <div class="container">
    <a class="navbar-brand" href="panelPropietario.php">AdminProp</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="panelPropietario.php">Inicio</a>
        </li>
        
        <li class="nav-item">
          <a class="nav-link" href="panelPropietario.php?op=27&idPropi=<?php echo $_SESSION["auth"]["idReg"];?>">Listado de Propiedades</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="panelPropietario.php?op=28">Ingresar Propiedad</a>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            <li><a class="dropdown-item" href="panelPropietario.php?op=5">Agregar Propiedad</a></li>
    ...
    ?>
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li><a class="dropdown-item" href="panelPropietario.php?op=999">Tu perfil de propietario</a></li>
            <li><a class="dropdown-item" href="panelPropietario.php?op=100">Seguridad y Contraseña</a></li>            
            <li><a class="dropdown-item" href="desconectarPropi.php">Cerrar Sesión</a></li>
          </ul>
        </li>
    ...
    <?php 
      if(isset($_GET["op"])){
        ...
        if($_SESSION["auth"]["tipo"]=="admin"){
          ...
          $controlProp->liquidacionPropi($_SESSION["auth"]["idReg"]);
        }
